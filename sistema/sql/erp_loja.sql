...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19/03/2026 às 02:14
...
(1, 'F', 'Emerson Carvalho', '360.673.818-85', '(19) 99819-8563', 'emersoncarvalho@hotmail.com.br', 'A', '13467-275', 'Via Francisco Boldrini', '100', '', 'Jardim Recanto', 'Americana', 'SP', 'A', '2026-03-16 20:33:45');
...
--
-- Estrutura para tabela `compras_historico`
--
...
--
-- Estrutura para tabela `fornecedor_logs`
--
...
--
-- Despejando dados para a tabela `fornecedor_logs`
--
...
--
-- Estrutura para tabela `pedidos_catalogo`
--
...
--
-- Despejando dados para a tabela `pedidos_catalogo`
--
...
(5, 'Emerson Carvalho', '19998198563', 'Dinheiro', 130.00, 'PENDENTE', '2026-03-18 21:40:06'),
(6, 'Emerson Carvalho', '19998198563', 'Dinheiro', 130.00, 'PENDENTE', '2026-03-18 21:50:44'),
(7, 'Emerson Carvalho', '19998198563', 'Dinheiro', 130.00, 'APROVADO', '2026-03-18 21:52:28');

-- --------------------------------------------------------

--
-- Estrutura para tabela `pedidos_catalogo_itens`
--
...
--
-- Despejando dados para a tabela `pedidos_catalogo_itens`
--
...
--
-- Estrutura para tabela `produtos_historico`
--
...
--
-- Despejando dados para a tabela `produtos_historico`
--
...
(2, 'Karina Fernandes', '', 'A', '2026-03-16 20:34:34', '(19) 98108-2383', 'karina@gmail.com', '$2y$10$vwCFt0UIdsecw5TEdKBQOe/.0GAgnweHZ9jsrDRjW8HdOBivezMKW', 'O');

-- --------------------------------------------------------

--
-- Estrutura para tabela `usuarios_historico`
--
...
INSERT INTO `vendas` (`id`, `cliente_id`, `data_pedido`, `forma_pagamento`, `parcelas`, `intervalo`, `valor_total`, `status`, `st_registro`, `data_cadastro`) VALUES
(1, 1, '2026-03-16 21:24:00', 'PRAZO', 2, 30, 2500.00, 'A', 'A', '2026-03-16 21:24:45');

-- --------------------------------------------------------

--
-- Estrutura para tabela `vendas_historico`
--
...
--
-- Índices de tabela `compras_historico`
--
...
--
-- Índices de tabela `fornecedor_logs`
--
...
--
-- Índices de tabela `pedidos_catalogo`
--
ALTER TABLE `pedidos_catalogo`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `pedidos_catalogo_itens`
--
...
--
-- Índices de tabela `produtos_historico`
--
...
--
-- Índices de tabela `usuarios_historico`
--
...
--
-- Índices de tabela `vendas_historico`
--
...
--
-- Restrições para tabelas `fornecedor_logs`
--
ALTER TABLE `fornecedor_logs`
